                        ...
                        <footer className="space-y-4">
                          <header className="space-y-2.5 lg:space-y-3.5">
                            ...
                            <div className="mt-3 pr-4 xl:pr-20">
                              <p>
                                A <em>luxurious</em> <em>floating villa </em>on
                                Ulaman's bio-filtered lake.
                              </p>
                            </div>
                          </header>
                          <nav>
                            <span className="ui-underline-anim reverse btn-primary uppercase">
                              Discover
                            </span>
                          </nav>
                        </footer>
                          ...
                          <header className="space-y-2.5 lg:space-y-3.5">
                            ...
                            <div className="mt-3 pr-4 xl:pr-20">
                              <p>
                                ...
                                <em>avatar-inspired </em>sky villa with 180°
                                views.
                              </p>
                            </div>
                          </header>
                        ...
                        <footer className="space-y-4">
                          <header className="space-y-2.5 lg:space-y-3.5">
                            ...
                            <div className="mt-3 pr-4 xl:pr-20">
                              <p>
                                Indulge in an{" "}
                                <em>exclusive riverside villa </em>with jungle
                                lagoon view.
                              </p>
                            </div>
                          </header>
                          <nav>
                            <span className="ui-underline-anim reverse btn-primary">
                              Discover
                            </span>
                          </nav>
                        </footer>
